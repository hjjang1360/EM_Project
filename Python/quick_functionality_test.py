...
def test_recovery_time():
    ...
    print(f"\nRecovery Times:")
    print(f"- Legal (≤50 mg/100mL): {recovery_times['legal']:.1f} hours" if recovery_times['legal'] else "- Legal: Not reached within 24h")
    print(f"- Safe (≤20 mg/100mL): {recovery_times['safe']:.1f} hours" if recovery_times['safe'] else "- Safe: Not reached within 24h")
    print(f"- Full recovery (≤5 mg/100mL): {recovery_times['full']:.1f} hours" if recovery_times['full'] else "- Full: Not reached within 24h")
