#!/usr/bin/env python3
"""
Simple Web BAC Calculator using Flask
웹 브라우저에서 사용할 수 있는 간단한 BAC 계산기
"""
...
def generate_graph(
    ...
    """Generate BAC graph and return as base64 string"""
    try:
...
<head>
    ...
    <title>🍺 BAC Calculator - 웹 버전</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>분수계 미분방정식을 이용한 정확한 BAC 예측 시스템</p>
        </div>
